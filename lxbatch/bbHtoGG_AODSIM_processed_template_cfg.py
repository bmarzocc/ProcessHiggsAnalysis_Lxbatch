# original version produced by job_maker on Fri Feb 14 11:30:54 2014
# command:
#   job_maker --MC --AOD --noskim --storage=eos --name=bbHtoGG_AODSIM_processed --datasetpath=/store/caf/user/bmarzocc/bbHtoGG_AODSIM/bbHtoGG_GEN-SIM --events=-1 --events_per_job=100 --outputdir=store/caf/user/bmarzocc/bbHtoGG_AODSIM_processed --globaltag=START53_V7N::All --hlttag=HLT
...
#ADDITIONAL OPTIONS
flagAOD = 'ON'
jobMaker = 'job_maker --MC --AOD --noskim --storage=eos --name=bbHtoGG_AODSIM_processed --datasetpath=/store/caf/user/bmarzocc/bbHtoGG_AODSIM/bbHtoGG_GEN-SIM --events=-1 --events_per_job=100 --outputdir=store/caf/user/bmarzocc/bbHtoGG_AODSIM_processed --globaltag=START53_V7N::All --hlttag=HLT'
...
process.h2ganalyzer.RootFileName = 'OUTPUTFILENAME.root'
